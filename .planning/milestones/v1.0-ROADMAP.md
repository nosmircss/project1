...
- [x] **Phase 2: Full Conditions + Settings** - Complete current conditions data, temperature/wind unit toggles, settings persistence
- [x] **Phase 3: Auto-Refresh** - Main-process scheduler, configurable interval, last-updated display and countdown
- [x] **Phase 4: Hourly Forecast + Multi-Location** - 12-24 hour forecast view, saved location management, one-click switching
